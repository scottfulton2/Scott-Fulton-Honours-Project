...
<div class="jumbotron text-center">
    <h1 class="text-center">External Technical Request Form</h1>
    <div>
...
<div class="container-fluid" style="padding:10">
  <div class="jumbotron text-right" style="margin-bottom:1px; padding:10">
    <form formaction="externalRequestFormHandle.php" method="post">
      ...
      <input type="text" name="organisation" value="" required><br>

      <label for="orgAddress">Address of Organisation/Institute *: </label>
      <textarea type="text" name="orgAddress" rows="5" cols="40" value="" required></textarea><br>
      ...
      <button type="submit" name="submit" formaction="externalRequestFormHandle.php">Submit</button>
    </form>
  </div>
</div>
<?php
